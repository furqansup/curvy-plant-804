...
let placedOrderFunc = () => {
    ...
    if (
          ...
          window.prompt("Rate this website on line 0 to 10")
          
          window.open("placed.html", "_self");
    }
};

document.getElementById("clickPayment").addEventListener("click", placedOrderFunc);
